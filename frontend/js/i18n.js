(function () {
  ...
  const dict = {
    zh: {
      ...
      'game.log.mustRevealTopFirst': '该玩家此牌下方仍有未翻开的牌，需先翻栈顶牌',
    ...
    en: {
      ...
      'game.log.mustRevealTopFirst': 'This player still has an unrevealed card on top. Reveal the top card first.',
